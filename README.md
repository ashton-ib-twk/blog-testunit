...
A Python tool that can physics simulator for browser given an ontology.

![demos-utils](./assets/logo.png)
...
demos-utils can be used for multiple purposes. We can run graph algorithms and calculate centralities to understand concept importance. We can calculate communities to bunch concepts together. We can understand connectedness between seemingly disconnected concepts.
...
```python
from demos-utils import GraphMaker, Ontology
...
```python
from demos-utils import Neo4jGraphModel
